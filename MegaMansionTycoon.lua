...
local Btn2 = MakeBtn("AUTO COMPRAR", UDim2.new(0,0,0,42))
local Btn3 = MakeBtn("VELOCIDAD", UDim2.new(0,0,0,84))
...
Btn1.MouseButton1Click:Connect(function()
    ...
    if CollectON then
        ...
        Btn1.BorderColor3 = Color3.new(0,1,0) -- VERDE
        ConnectionCollect = RunService.Heartbeat:Connect(function()
            ...
            task.wait(0.1) -- ANTI LAG
        end)
    else
        Btn1.Text = "AUTO COLLECT"
        Btn1.BorderColor3 = Color3.new(1,0,0) -- ROJO
        if ConnectionCollect then ConnectionCollect:Disconnect() end
    end
end)

-- === AUTO COMPRAR (SIN LAG) ===
Btn2.MouseButton1Click:Connect(function()
    BuyON = not BuyON
    if BuyON then
        Btn2.Text = "AUTO COMPRAR [ON]"
        Btn2.BorderColor3 = Color3.new(0,1,0) -- VERDE
        ConnectionBuy = RunService.Heartbeat:Connect(function()
            ...
            task.wait(0.2) -- ✅ ESTO QUITA EL LAG, ESPERA UN POCO
        end)
    else
        Btn2.Text = "AUTO COMPRAR"
        Btn2.BorderColor3 = Color3.new(1,0,0) -- ROJO
...
Btn3.MouseButton1Click:Connect(function()
    ...
    if SpeedON then
        ...
        Btn3.BorderColor3 = Color3.new(0,1,0) -- VERDE
        Hum.WalkSpeed = 70
    else
        Btn3.Text = "VELOCIDAD"
        Btn3.BorderColor3 = Color3.new(1,0,0) -- ROJO
        Hum.WalkSpeed = 16
    end
end)
