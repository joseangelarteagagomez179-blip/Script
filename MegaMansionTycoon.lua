...
Main.Size = UDim2.new(0, 260, 0, 300) -- MAS ANCHO
...
local InfoFrame = Instance.new("ScrollingFrame") -- AQUI ESTA EL CAMBIO
InfoFrame.Size = UDim2.new(1, -20, 1, -65)
InfoFrame.Position = UDim2.new(0, 10, 0, 35)
InfoFrame.BackgroundTransparency = 1
InfoFrame.BorderSizePixel = 0
InfoFrame.ScrollBarThickness = 4
InfoFrame.CanvasSize = UDim2.new(0,0, 2, 0) -- TAMAÑO PARA DESLIZAR
